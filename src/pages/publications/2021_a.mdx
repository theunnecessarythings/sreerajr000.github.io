...
link: https://ui.adsabs.harvard.edu/abs/2021arXiv211004427V/abstract

citation: | 
  @INPROCEEDINGS{9660182,
  author={Nadimpalli, Aakash Varma and Reddy, Narsi and Ramachandran, Sreeraj and Rattani, Ajita},
  ...
  number={},
  pages={1-7},
  keywords={Deep learning;Training;Data privacy;Parameter estimation;Biometrics (access control);Computational modeling;Semisupervised learning;Unlabeled data;Deep Learning;Soft Biometrics;Self-ensemble;Semi-supervised learning},
