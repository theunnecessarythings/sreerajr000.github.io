...
id: twod_physics
title: "TwoD Physics"
subtitle: "TwoDPhysics is a 2D rigid body simulation add-on for Blender 2.80"
image: "images/twod_physics.webp"
date: 2021-10-01
---
...
# TwoD-Physics Addon for Blender

## A 2D rigid body simulation addon for Blender

<figure class="image">
  <img style="width: auto; margin:auto;" src="images/twod_physics.webp" alt="TwoD-Physics Addon for Blender"/>
</figure>
<br/>

## Archive Notice

This [repository](https://github.com/theunnecessarythings/twod-physics/) serves as an archive for the TwoD-Physics addon. The addon is no longer being actively developed or updated. While it has been an essential tool for many Blender users, compatibility with newer versions of Blender (post-update information) cannot be guaranteed.
...
<iframe style="display:block; margin:auto;" width="100%" height="315" src="https://www.youtube.com/embed/V23GcxtE5EA?si=vFs6mVaSIUbNxewn" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
